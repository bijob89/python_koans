...
class AboutDictionaries(Koan):
    ...
    def test_dictionary_keys_and_values(self):
        ...
        self.assertEqual('uno' in babel_fish.values(), 'one' in babel_fish.keys())
        self.assertEqual('dos' in babel_fish.keys(), 'two' in babel_fish.values())
        self.assertEqual('one' in babel_fish.values(), 'uno' in babel_fish.keys())
        self.assertEqual('two' in babel_fish.keys(), 'dos' in babel_fish.values())
